...
initial_elo = 1200
opponent_elo = 2000  # Assuming Stockfish has a very high rating
...
def Max(state, depth, alpha, beta):
    ...
    transposition_table[state_key] = (val, best_move)
...
def evaluate_game():
    global games_played, ai_wins, ai_losses, draws, initial_elo
    result = board.result()
    games_played += 1
    if result == '1-0':
